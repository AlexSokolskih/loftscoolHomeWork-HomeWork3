    ...
    <div class="container">
      ...
      <div class="form-container">
        <form class="form-horizontal" action="index.php?page=reg&event=registration" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="password" class="form-control" id="inputPassword3" placeholder="Пароль" name="password1">
            </div>
          </div>
          <div class="form-group">
